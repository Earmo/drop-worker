/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.example.jsonc --strict-vars=false worker/types/worker-configuration.d.ts` (hash: eaf55f44db1786e152215a50cd1df5c2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_DRIVER" | "AUTH_MODE" | "MAX_STORAGE_BYTES" | "PUBLIC_URL" | "SHARING_ENABLED" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_PUBLIC_URL" | "OWNER_EMAIL" | "AUTH_FROM_NAME" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_SECURE" | "SMTP_FROM" | "SMTP_TIMEOUT_MS">> {}
}
