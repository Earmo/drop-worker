/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.example.jsonc --strict-vars=false worker/types/worker-configuration.d.ts` (hash: ddd853846314cd3ed40e55bdb051d303)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "MAX_STORAGE_BYTES" | "PUBLIC_URL" | "SHARING_ENABLED" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_PUBLIC_URL" | "OWNER_EMAIL" | "AUTH_FROM_NAME" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_SECURE" | "SMTP_FROM" | "SMTP_TIMEOUT_MS">> {}
}
