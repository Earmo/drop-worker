/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.example.jsonc --strict-vars=false worker/types/worker-configuration.d.ts` (hash: 1157693fff1c40ddcd8529a24b799032)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "AUTH_EMAIL_PROVIDER" | "MAX_STORAGE_BYTES" | "PUBLIC_URL" | "SHARING_ENABLED" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_PUBLIC_URL" | "OWNER_EMAIL" | "AUTH_FROM_EMAIL" | "AUTH_FROM_NAME" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_SECURE" | "SMTP_FROM" | "SMTP_TIMEOUT_MS" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD">> {}
}
